								...
								<div class="viptab">
									<div class="details-hd">
										<ul class="ui-switchable-nav" data-role="nav">
											<li class=" ui-switchable-active" data-role="trigger">全部积分</li>
											<li data-role="trigger"><a href="vip2.php">积分收入</a></li>
											<li data-role="trigger"><a href="vip3.php">积分支出</a></li>
											<div class="fill"></div>
										</ul>
									</div>
											...
											<div class="viptab-table">
												...
												<div class="viptab-tbody">
													<ul>
														...
														<li class="w2">订单：201321421321</li>
														<li class="w3 font_green">+4600</li>
														<li class="w4">2014-11-26：00:00</li>
													</ul>
													<ul>
														<li class="w1">积分兑换</li>
														<li class="w2">品胜iPhone5S手机套硅胶</li>
														<li class="w3 font_green">-1500</li>
														<li class="w4">2014-11-26：00:00</li>
													</ul>
													<ul>
														<li class="w1">晒单送积分</li>
														<li class="w2">iPhone 5S  16G白</li>
